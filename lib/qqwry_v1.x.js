...
Qqwry.prototype.speed = function(){
	...
	this.ipFileBuffer = fs.readFileSync(Path); //缓存IP库文件;
	// this.ipBegin = this.ipFileBuffer.readUInt32LE(0,true); //索引的开始位置;
	// this.ipEnd = this.ipFileBuffer.readUInt32LE(4,true); //索引的结束位置;
	return this;
}
